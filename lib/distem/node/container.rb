    ...
    class Container
      ...
      def start
        ...
        @@contsem.synchronize do
          ...
          @vnode.vifaces.each do |viface|
            Lib::Shell::run("ethtool -K #{Lib::NetTools.get_iface_name(@vnode,viface)} gso off || true; true")
            Lib::Shell::run("ethtool -K #{Lib::NetTools.get_iface_name(@vnode,viface)} tso off || true; true")
          end
          @cpuforge.apply
